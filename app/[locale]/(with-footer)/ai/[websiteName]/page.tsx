...
export async function generateMetadata({
  ...
  const title = locale !== 'en' && data[0].translations && data[0].translations[1][locale] ? data[0].translations[1][locale].title : data[0].title;
  const content = locale !== 'en' && data[0].translations && data[0].translations[1][locale] ? data[0].translations[1][locale].content : data[0].content;
...
export default async function Page({ params: { locale, websiteName } }: { params: { locale: string; websiteName: string } }) {
  ...
  const data = locale !== 'en' && dataList[0].translations && dataList[0].translations[1][locale] ?
    dataList[0].translations[1][locale] :
    dataList[0];
